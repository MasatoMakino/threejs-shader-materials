...
const ShaderSpriteMaterial_glsl_1 = require("./ShaderSpriteMaterial.glsl");
...
class ShaderSpriteMaterial extends three_1.ShaderMaterial {
    ...
    constructor(vertexShader, fragmentShader, parameters) {
        ...
        vertexShader !== null && vertexShader !== void 0 ? vertexShader : (vertexShader = ShaderSpriteMaterial_glsl_1.vertex);
        fragmentShader !== null && fragmentShader !== void 0 ? fragmentShader : (fragmentShader = ShaderSpriteMaterial_glsl_1.fragment);
        this.initChunks();
        this.initUniforms();
        this.initDefines();
     ...
     */
    initChunks() {
        chunk_1.SpriteChunk.registerChunk();
    }
    /**
     * uniformsを初期化する。
     */
    initUniforms() {
        this.uniforms = three_1.UniformsUtils.merge([chunk_1.SpriteChunk.getUniform(), {}]);
    }
    /**
     * definesを初期化する。
     */
    initDefines() {
        this.defines = Object.assign({}, chunk_1.SpriteChunk.getDefines(), this.defines);
    }
    /**

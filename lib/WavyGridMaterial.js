...
const chunk_3 = require("./chunk");
const chunk_4 = require("./chunk");
...
class WavyGridMaterial extends GridMaterial_1.GridMaterial {
    ...
    initChunks() {
        super.initChunks();
        chunk_4.WavyAnimationChunk.registerChunk();
    }
    static getBasicUniforms() {
        return three_1.UniformsUtils.merge([
            super.getBasicUniforms(),
            chunk_3.ReversibleChunk.getUniform(),
            chunk_4.WavyAnimationChunk.getUniform(),
            chunk_2.MaskMapChunk.getUniform(),
        ]);
    }

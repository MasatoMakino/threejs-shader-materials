...
const ExpansionChunk_1 = require("./chunk/ExpansionChunk");
const MapChunk_1 = require("./chunk/MapChunk");
const MeshPhongChunk_1 = require("./chunk/MeshPhongChunk");
const SurfaceNormalChunk_1 = require("./chunk/SurfaceNormalChunk");
...
class ShaderPhongMaterial extends three_1.ShaderMaterial {
    ...
    constructor(vertexShader, fragmentShader, parameters) {
        ...
        vertexShader !== null && vertexShader !== void 0 ? vertexShader : (vertexShader = ShaderPhongMaterial_vert_glsl_1.default());
        fragmentShader !== null && fragmentShader !== void 0 ? fragmentShader : (fragmentShader = ShaderPhongMaterial_frag_glsl_1.default());
        this.initChunks();
        this.initUniforms();
        this.initDefines();

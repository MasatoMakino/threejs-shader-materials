...
class ShaderPhongMaterial extends three_1.ShaderMaterial {
    ...
    constructor(vertexShader, fragmentShader, parameters) {
        ...
        vertexShader !== null && vertexShader !== void 0 ? vertexShader : (vertexShader = ShaderPhongMaterial_glsl_1.vertex);
        fragmentShader !== null && fragmentShader !== void 0 ? fragmentShader : (fragmentShader = ShaderPhongMaterial_glsl_1.fragment);
        this.initChunks();
        this.initUniforms();
        this.initDefines();

...
class FBMFireMaterial extends ShaderPhongMaterial_1.ShaderPhongMaterial {
    ...
    initUniforms() {
        this.uniforms = three_1.UniformsUtils.merge([
            ...
            chunk_2.TilingFBMChunk.getUniform(),
    ...
    initChunks() {
        super.initChunks();
        chunk_2.TilingFBMChunk.registerChunk();
        chunk_1.AnimationChunk.registerChunk();
    }
    initDefines() {
        super.initDefines();
        this.defines = Object.assign({}, chunk_2.TilingFBMChunk.getDefines(), this.defines);

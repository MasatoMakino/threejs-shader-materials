...
const FBMFireMaterial_glsl_1 = require("./FBMFireMaterial.glsl");
const raf_ticker_1 = require("@masatomakino/raf-ticker");
const three_1 = require("three");
class FBMFireMaterial extends __1.ShaderPhongMaterial {
    get tiles() {
    ...
    constructor(parameters) {
        super(ShaderPhongMaterial_glsl_1.vertex, FBMFireMaterial_glsl_1.fragment, parameters);
        /**
         * 波の速度
         * 0.5にすると1の半分の速度になる。
    ...
    initUniforms() {
        this.uniforms = three_1.UniformsUtils.merge([
            ...
            chunk_1.AnimationChunk.getUniform(),
            {
                strength: { value: 0.45 },
                bloom: { value: 0.1 },
    ...
    initChunks() {
        ...
        chunk_1.AnimationChunk.registerChunk();
    }
    initDefines() {
        super.initDefines();

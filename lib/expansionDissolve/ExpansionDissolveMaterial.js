...
const ExpansionDissolveMaterial_glsl_1 = require("./ExpansionDissolveMaterial.glsl");
...
class ExpansionDissolveMaterial extends index_1.ShaderPhongMaterial {
    ...
    constructor(parameters) {
        super(ExpansionDissolveMaterial_glsl_1.vertex, ExpansionDissolveMaterial_glsl_1.fragment, parameters);
        // IAnimatable //
        this.speed = -0.5;
        /*

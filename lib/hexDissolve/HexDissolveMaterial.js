...
const HexDissolveMaterial_glsl_1 = require("./HexDissolveMaterial.glsl");
...
class HexDissolveMaterial extends GridMaterial_1.GridMaterial {
    ...
    constructor(parameters) {
        super(null, HexDissolveMaterial_glsl_1.fragment, parameters);
    }
    initUniforms() {
        this.uniforms = three_1.UniformsUtils.merge([
            GridMaterial_1.GridMaterial.getBasicUniforms(),
            {
                ...
                gridEmissive: { value: new three_1.Color(0x000000) },

...
export class RimEdgesGeometry extends BufferGeometry {
    constructor(geometry = null, thresholdAngle = 1) {
        ...
        this.setAttribute("control0", new Float32BufferAttribute(control0, 3, false));
        this.setAttribute("control1", new Float32BufferAttribute(control1, 3, false));
        this.setAttribute("direction", new Float32BufferAttribute(direction, 3, false));
        this.setAttribute("collapse", new Float32BufferAttribute(collapse, 1, false));
    }
    ...
    static convertAttributeToVector3Array(attribute) {
        ...
        for (let s = 0; s < attribute.array.length; s++) {
            array.push(new Vector3(attribute.array[s * 3], attribute.array[s * 3 + 1], attribute.array[s * 3 + 2]));
        }
        return array;
    }
    /**
